...
public:
	...
	void BulletApplyDamage(class ABP_BaseCharacter_C* Instigator, class UClass* DamageType, const struct FHitResult& Hit);
	void ReceiveBeginPlay();
	void ReceiveTick(float DeltaSeconds_ReceiveTick);
	void Server_ApplyPointDamageServer(class ABP_BaseCharacter_C* Instigator, class UClass* DamageType, const struct FHitResult& Hit);
